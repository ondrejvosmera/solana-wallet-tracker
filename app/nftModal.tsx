...
const NftModal: React.FC<NftModalProps> = ({ imageUrl, onClose, nftAttributes, nftName }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div ref={modalRef} className="flex flex-col bg-gray-200 text-black dark:bg-gray-800 dark:text-white p-10 rounded-3xl relative max-w-[80%] overflow-auto">
        ...
        <div className='flex flex-row gap-12'>
          <img src={imageUrl} alt="NFT" className="w-[32rem] mb-4 object-cover" />
