...
export interface GuessWhoGetLeaderboard {
}
export interface GuessWhoGetLeaderboardRequestArgs {
    /**
...
export declare class GuessWhoGetLeaderboardRequest extends BaseRequest<GuessWhoGetLeaderboardRequestArgs, PaginatedResponse<GuessWhoGetLeaderboard>> {
    readonly body: GuessWhoGetLeaderboardRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/ikons/guess-who/get-leaderboard";
    constructor(body?: GuessWhoGetLeaderboardRequestArgs);
}
