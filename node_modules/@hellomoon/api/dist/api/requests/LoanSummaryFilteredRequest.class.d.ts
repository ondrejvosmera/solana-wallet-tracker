...
export interface LoanSummaryFiltered {
    /**
    ...
    /**
     * If the loan was canceled.
     * `optional field`
     */
    loanIsCanceled: boolean;
}
export interface LoanSummaryFilteredRequestArgs {
    /**
     * > To find the correct helloMoonCollectionId, **[click here](https://www.hellomoon.io/id?search=collection)**
     * and search a collection name. This list is continuously updated.
     * `optional field`
...
export declare class LoanSummaryFilteredRequest extends BaseRequest<LoanSummaryFilteredRequestArgs, PaginatedResponse<LoanSummaryFiltered>> {
    readonly body: LoanSummaryFilteredRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/sharky/loan-summary/filtered";
    constructor(body?: LoanSummaryFilteredRequestArgs);
}
