...
export interface MathWhizzAdmin {
}
export interface MathWhizzAdminRequestArgs {
    walletId?: string;
    /**
...
export declare class MathWhizzAdminRequest extends BaseRequest<MathWhizzAdminRequestArgs, PaginatedResponse<MathWhizzAdmin>> {
    readonly body: MathWhizzAdminRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/wenlambo/math_whizz/admin";
    constructor(body?: MathWhizzAdminRequestArgs);
}
