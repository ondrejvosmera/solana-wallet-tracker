...
export interface RfqProdRfqByExpiration {
    /**
...
export interface RfqProdRfqByExpirationRequestArgs {
    expirationTime?: {
        operator: "=" | "!=" | ">" | "<" | ">=" | "<=";
        /**
     * The expiration date of the RFQ account
...
export declare class RfqProdRfqByExpirationRequest extends BaseRequest<RfqProdRfqByExpirationRequestArgs, PaginatedResponse<RfqProdRfqByExpiration>> {
    readonly body: RfqProdRfqByExpirationRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/rfq-prod/rfq-by-expiration";
    constructor(body?: RfqProdRfqByExpirationRequestArgs);
}
