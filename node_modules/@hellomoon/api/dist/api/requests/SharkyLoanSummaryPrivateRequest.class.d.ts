...
export interface SharkyLoanSummaryPrivate {
    /**
...
export interface SharkyLoanSummaryPrivateRequestArgs {
    /**
     * Meteplex mint address of the nft being used as collateral
     * `optional field`
     */
...
export declare class SharkyLoanSummaryPrivateRequest extends BaseRequest<SharkyLoanSummaryPrivateRequestArgs, PaginatedResponse<SharkyLoanSummaryPrivate>> {
    readonly body: SharkyLoanSummaryPrivateRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/sharky/loan-summary-private";
    constructor(body?: SharkyLoanSummaryPrivateRequestArgs);
}
