...
export interface RfqProdRfqByCreation {
    /**
...
export interface RfqProdRfqByCreationRequestArgs {
    expirationTime?: {
        operator: "=" | "!=" | ">" | "<" | ">=" | "<=";
        /**
     * The expiration date of the RFQ account
...
export declare class RfqProdRfqByCreationRequest extends BaseRequest<RfqProdRfqByCreationRequestArgs, PaginatedResponse<RfqProdRfqByCreation>> {
    readonly body: RfqProdRfqByCreationRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/rfq-prod/rfq-by-creation";
    constructor(body?: RfqProdRfqByCreationRequestArgs);
}
