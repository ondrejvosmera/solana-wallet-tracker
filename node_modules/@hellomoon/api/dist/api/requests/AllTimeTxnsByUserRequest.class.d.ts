...
export interface AllTimeTxnsByUser {
    userAccount: string;
     ...
     */
    blockId: number;
    type: Array<"NFT_SALE" | "NFT_LISTING/DELISTING" | "TOKEN_SWAP" | "WITHDRAWAL/DEPOSITS" | "BORROWING/LENDING" | "NFT_MINT" | "TOKEN_TRANSFERS"> | "NFT_SALE" | "NFT_LISTING/DELISTING" | "TOKEN_SWAP" | "WITHDRAWAL/DEPOSITS" | "BORROWING/LENDING" | "NFT_MINT" | "TOKEN_TRANSFERS";
    /**
     * The data field contains the transaction details. The data field is an object with the following fields:
     *                         > NFT_SALE ~ nftSaleObject
     *                         > NFT_MINT ~ nftMintObject
     *                         > NFT_LISTING ~ nftListingObject
     *                         > DEFI_SWAPS ~ defiSwapsObject
     *                         > DEFI_LIQUIDITY_POOLS ~ defiLiquidityPoolsObject
     *                         > DEFI_LENDING ~ defiLendingObject
     *                         > TOKEN_TRANSFER ~ tokenTransfersObject
     *         You can JSON parse this field to get the data.
     *         _**optional field**_
     */
    parsedInfo: {
...
export interface AllTimeTxnsByUserRequestArgs {
    userAccount?: string;
    /**
     * Use this object when you get blocktime between two numbers
     * `optional field`
...
export declare class AllTimeTxnsByUserRequest extends BaseRequest<AllTimeTxnsByUserRequestArgs, PaginatedResponse<AllTimeTxnsByUser>> {
    readonly body: AllTimeTxnsByUserRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/solana/all-time/txns-by-user";
    constructor(body?: AllTimeTxnsByUserRequestArgs);
}
