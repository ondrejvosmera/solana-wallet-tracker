...
export interface TokenPriceRequestArgs {
    /**
     * Mint address per the SPL token program.
     *       > You can also visit https://www.hellomoon.io/id?search=token to search for mints using a user
     * interface.
...
export declare class TokenPriceRequest extends BaseRequest<TokenPriceRequestArgs, PaginatedResponse<TokenPrice>> {
    readonly body: TokenPriceRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/token/price";
    constructor(body?: TokenPriceRequestArgs);
}
