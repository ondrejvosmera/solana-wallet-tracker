...
export interface AccountDataDevnet {
    /**
...
export interface AccountDataDevnetRequestArgs {
    /**
     * First signature in a transaction, which can be used to track and verify the transaction status across
     * the complete ledger.
     *         It is a base-58 encoded string that is uniquely generated for each transaction.
...
export declare class AccountDataDevnetRequest extends BaseRequest<AccountDataDevnetRequestArgs, PaginatedResponse<AccountDataDevnet>> {
    readonly body: AccountDataDevnetRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/account-data/devnet";
    constructor(body?: AccountDataDevnetRequestArgs);
}
