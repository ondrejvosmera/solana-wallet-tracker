...
export interface RfqRfqByCreation {
    /**
...
export interface RfqRfqByCreationRequestArgs {
    expirationTime?: {
        operator: "=" | "!=" | ">" | "<" | ">=" | "<=";
        /**
     * The expiration date of the RFQ account
...
export declare class RfqRfqByCreationRequest extends BaseRequest<RfqRfqByCreationRequestArgs, PaginatedResponse<RfqRfqByCreation>> {
    readonly body: RfqRfqByCreationRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/rfq/rfq-by-creation";
    constructor(body?: RfqRfqByCreationRequestArgs);
}
