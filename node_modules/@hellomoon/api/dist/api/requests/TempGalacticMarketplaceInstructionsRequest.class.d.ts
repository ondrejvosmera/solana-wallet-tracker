...
export interface TempGalacticMarketplaceInstructions {
    /**
    ...
    programId: string;
    /**
     * a set of galactic marketplace instruction names
     */
...
export interface TempGalacticMarketplaceInstructionsRequestArgs {
    blocktime?: {
        operator: "=" | "!=" | ">" | "<" | ">=" | "<=";
        /**
     * Unix epoch time (in seconds) of a block as calculated from validator votes.
...
export declare class TempGalacticMarketplaceInstructionsRequest extends BaseRequest<TempGalacticMarketplaceInstructionsRequestArgs, PaginatedResponse<TempGalacticMarketplaceInstructions>> {
    readonly body: TempGalacticMarketplaceInstructionsRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/hello-moon/galactic_marketplace";
    constructor(body?: TempGalacticMarketplaceInstructionsRequestArgs);
}
