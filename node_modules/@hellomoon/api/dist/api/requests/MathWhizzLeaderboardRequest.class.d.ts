...
export interface MathWhizzLeaderboard {
}
export interface MathWhizzLeaderboardRequestArgs {
    /**
...
export declare class MathWhizzLeaderboardRequest extends BaseRequest<MathWhizzLeaderboardRequestArgs, PaginatedResponse<MathWhizzLeaderboard>> {
    readonly body: MathWhizzLeaderboardRequestArgs;
    readonly method = "POST";
    readonly url = "/v0/wenlambo/math_whizz/leaderboard";
    constructor(body?: MathWhizzLeaderboardRequestArgs);
}
